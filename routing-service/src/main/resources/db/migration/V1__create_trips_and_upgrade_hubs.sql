-- =========================================================================
-- FLYWAY MIGRATION V1: NÂNG CẤP BẢNG HUBS & TẠO CÁC BẢNG QUẢN LÝ CHUYẾN XE
-- CƠ SỞ DỮ LIỆU: routing_db
-- =========================================================================

-- 1. Bổ sung cột phân cấp Mạng Nhện cho bảng hubs (nếu chưa có)
...
EXEC('UPDATE hubs SET hub_type = ''SUPER_HUB'', parent_hub_code = NULL WHERE hub_code IN (''HUB-HN-01'', ''HUB-DN-01'', ''HUB-HCM-01'')');
EXEC('UPDATE hubs SET hub_type = ''LOCAL_HUB'', parent_hub_code = ''HUB-HN-01'' WHERE hub_code = ''HUB-HP-01''');
EXEC('UPDATE hubs SET hub_type = ''LOCAL_HUB'', parent_hub_code = ''HUB-HCM-01'' WHERE hub_code = ''HUB-CT-01''');
